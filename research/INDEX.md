...
- [manzaltu/claude-code-ide.el](research/manzaltu__claude-code-ide.el.md) ⭐0 · _stable_ · [hackernews] · 782↑ — Native Emacs integration for Claude Code via MCP (LSP/tree-sitter/imenu/project as MCP tools)
- [htdt/godogen](research/htdt__godogen.md) ⭐0 · _emerging_ · [hackernews] · 337↑ — Generator publishing thin per-game repos that a Claude Code/Codex agent builds into full games with proof-over-claims verification
...
- [anthropics/claude-code](research/anthropics__claude-code.md) ⭐0 · _stable_ · [hackernews] · 1364↑ — Anthropic's own Claude Code CLI repo; HN item was an issue thread, not a new tool
- [aattaran/deepclaude](research/aattaran__deepclaude.md) ⭐0 · _experimental_ · [hackernews] · 678↑ — Wrapper repointing Claude Code CLI's model backend at DeepSeek/other APIs; ToS gray zone, not recommended
- [anomalyco/opencode](research/anomalyco__opencode.md) ⭐0 · _stable_ · [hackernews] · 625↑ — Open-source multi-model coding agent CLI (competing tool); HN item was about Anthropic subscription restrictions
- [LaurieWired/GhidraMCP](research/LaurieWired__GhidraMCP.md) ⭐0 · _stable_ · [hackernews] · 356↑ — MCP server + Ghidra plugin for autonomous binary reverse engineering; duplicate of existing bethington/ghidra-mcp entry
