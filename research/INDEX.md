...
- [LaurieWired/GhidraMCP](research/LaurieWired__GhidraMCP.md) ⭐9852 · _stable_ · [hackernews] — MCP server exposing Ghidra reverse-engineering functionality to LLMs
...
- [htdt/godogen](research/htdt__godogen.md) ⭐5574 · _emerging_ · [hackernews] — Thin-repo agent-scaffold generator for autonomous game dev (Godot/Bevy/Babylon.js)
...
- [cathrynlavery/diagram-design](research/cathrynlavery__diagram-design.md) ⭐0 · _trending_ · [github-trending] — Claude Code skill generating 27 editorial diagram types as static HTML/SVG, brand-matched
...
## skip (39)
- [anomalyco/opencode](research/anomalyco__opencode.md) ⭐200908 · _stable_ · [hackernews] — Competing open-source provider-agnostic AI coding agent CLI
