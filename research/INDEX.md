...
- [anthropics/claude-plugins-community](research/anthropics__claude-plugins-community.md) ⭐1234 · _stable_ · [github-trending] — Anthropic's official curated Claude Code/Cowork community plugin marketplace mirror
...
- [apache/maka](research/apache__maka.md) ⭐2706 · _emerging_ · [github-trending] — ASF-incubating local-first agent workspace with durable execution-record design
...
- [manzaltu/claude-code-ide.el](research/manzaltu__claude-code-ide.el.md) ⭐1650 · _stable_ · [hackernews] — Emacs MCP bridge exposing LSP/tree-sitter/project.el to Claude Code
...
- [anthropics/claude-code](research/anthropics__claude-code.md) ⭐142844 · _stable_ · [hackernews] — Claude Code CLI itself; not a new discovery
...
- [aattaran/deepclaude](research/aattaran__deepclaude.md) ⭐2253 · _trending_ · [hackernews] — Repoints Claude Code CLI at non-Anthropic backends (DeepSeek/OpenRouter/Fireworks) for cost
