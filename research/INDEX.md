...
- [NeoLabHQ/context-engineering-kit](research/NeoLabHQ__context-engineering-kit.md) ⭐1716 · _emerging_ · [hackernews] · 44↑ — Hand-crafted, minimal-token-footprint Claude Code skills/plugins for context engineering and result quality — directly matches our token-thrift mission
...
- [alexgreensh/attention-span](research/alexgreensh__attention-span.md) ⭐1123 · _emerging_ · [github] — Drop-in Claude Code output-style markdown files (answer-first, concise-by-default) that cut response tokens as a side effect of being kind to attention — small, directly reusable asset
...
- [JayPokale/Chisle](research/JayPokale__Chisle.md) ⭐492 · _emerging_ · [github] — Injected ruleset (terse prose + YAGNI-first code + tool-output compression) that measurably cuts an agent's output tokens (44% of baseline in published benchmarks incl. losses) — zero-dep, directly on our token-thrift mission
...
- [rsmdt/the-startup](research/rsmdt__the-startup.md) ⭐517 · _stable_ · [github] — Multi-agent spec-driven-development framework (commands/skills/agents/output-styles/statusline) for Claude Code — full competing framework, overlaps with our own superpowers skills; watch for individual ideas rather than wholesale adoption
- [Hainrixz/the-architect](research/Hainrixz__the-architect.md) ⭐506 · _emerging_ · [github] — Claude Code meta-agent that interviews the user and writes a self-contained blueprint (EARS acceptance criteria + per-step verify command) for a zero-context build — technique worth referencing when improving our planning/handover skills
- [yonatangross/orchestkit](research/yonatangross__orchestkit.md) ⭐280 · _emerging_ · [github] — Very large bundled toolkit for Claude Code (107 skills, 36 agents, 171 hooks) with its own CLI installer and community — worth mining for specific hook/skill ideas later, too broad to adopt wholesale
- [prekuter/dryforge](research/prekuter__dryforge.md) ⭐269 · _emerging_ · [github] — Bounded-autonomy plugin harness for Claude Code/Codex (user-approved intent, spec-bound execution, evidence-backed verification, persistent project context) — conceptually close to our own AGENT-DIRECTIVE autonomy model, worth comparing when revising it
- [Avijit07x/claude-db](research/Avijit07x__claude-db.md) ⭐227 · _emerging_ · [github] — Pluggable-database persistent memory for Claude Code: hook-driven auto-capture/recall plus a code-graph MCP (usages/explain/path) — alternative, more code-graph-aware memory architecture worth watching
