...
<!-- claude-common:begin -->
<!-- Managed by claude-common v1.0.0 via scripts/sync-consumers.sh — edit upstream, not here. -->
@AGENT-DIRECTIVE.md

**Shared agent toolkit (claude-common v1.0.0).** Before building tooling, scripts, agents or hooks
